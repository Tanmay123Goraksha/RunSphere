...
import { fetchRunsApi } from '@/services/runApi';
import { getLocalRuns, upsertLocalRun } from '@/services/runStorage';
import { runSphereTheme } from '@/constants/runSphereTheme';

const toRunRow = (localRun) => ({
    id: localRun.id,
...
export default function HistoryScreen() {
    ...
    const loadRuns = useCallback(async () => {
        ...
        const byId = new Map(localRuns.map((run) => [run.id, toRunRow(run)]));
