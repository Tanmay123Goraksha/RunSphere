...
export const useSonarPing = (active: boolean) => {
...
export const useShimmer = (active: boolean) => {
...
export const useContestedPulse = (active: boolean) => {
...
export const useGlowPulse = (active: boolean) => {
